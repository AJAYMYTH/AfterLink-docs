...
interface HellBackgroundProps {
  ...
  className?: string;
  /** Primary accent colour (hex). Defaults to AfterLink cyan. */
  color?: string;
}
...
const fragmentShaderSource = `
  ...
  #define COLOUR_1 vec4(uColor1.rgb, 1.0)
  #define COLOUR_2 vec4(uColor2.rgb, 1.0)
  #define COLOUR_3 vec4(uColor3.rgb, 1.0)
  #define CONTRAST 3.5
  #define LIGTHING 0.4
...
function HellBackground({
  ...
  className = "",
  // AfterLink dark-mode cyan — feels electric against the black canvas
  color = "#00d8ff",
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const c1 = dark ? color : "#0099cc";
      const c2 = dark ? "#003b5c" : "#e6f4f8";
      const c3 = dark ? "#000000" : "#ffffff";
  ...
  const finalBlurClass = blurClassMap[backdropBlurAmount as BlurSize] ?? blurClassMap["none"];
